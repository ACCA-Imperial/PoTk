...
methods(Hidden)
    ...
    function printAnalyticExpression(pv)
        if pv.entirePotential
            fprintf([...
                'For N point vortices located at a_k for 1 <= k <= N,\n', ...
                ...
                '/      2 i pi\n', ...
                '--- k=1\n', ...
                '\nwhere C_k is the strength of the kth vortex.\n'])
            return
        end
        
        fprintf([...
            'Let w(z,a) be the Schottky-Klein prime function.\n', ...
            'Define the modified Green''s function to be\n\n', ...
            '                             /        w(z, a)      \\\n', ...
            '                     1       |-------------------- |\n', ...
            'G_0(z,a,conj(a)) = ------ log|      /       1    \\ |\n', ...
            '                   2 i pi    | |a| w| z, ------- | |\n', ...
            '                             \\      \\    conj(a) / /\n', ...
            '\nthen the potential for N vortices located at a_k \n', ...
            'for 1 <= k <= N is given by\n\n', ...
            '  --- N\n', ...
            '  \\\n', ...
            '   .     C_k G_0(z, a_k, conj(a_k))\n', ...
            '  /\n', ...
            '  --- k=1\n', ...
            '\nwhere C_k is the strength of the kth vortex.\n'])
    end
